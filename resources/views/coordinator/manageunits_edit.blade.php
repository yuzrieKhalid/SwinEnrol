    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <div class="prerequisite_groups">
                <div class="panel panel-default panel-body hidden prerequisite_group_template">
                ...
                <div class="panel panel-default panel-body prerequisite_group">
                    <div class="prerequisites">
                        ...
                        <div class="form-inline">
                            <div class="form-group">
                                <label for="prerequisiteGroupCount">Minimum Units to Complete:</label>
                                <input type="text" class="form-control" id="prerequisiteGroupCount" @if(count($prerequisites[$i][0]['type']) > 1) value="{{ $prerequisites[$i][0]['type'][1] }}" @endif>
                            </div>
                        </div>
                        <hr>
                        <div class="row hidden prerequisite_template">
